...
if FRED_HUTCH_HACKS:
    ...
    NEW_MPNN_SCRIPT = '/home/pbradley/gitrepos/clean/cleaner/ProteinMPNN/protein_mpnn_run.py'
    SPEC_MPNN_SCRIPT = '/home/pbradley/gitrepos/SpecDesignProteinMPNN/protein_mpnn_run.py'
    SABDAB_DIR = '/home/pbradley/csdat/sabdab/'
    ...
    NEW_MPNN_SCRIPT = '/software/lab/mpnn/proteinmpnn/protein_mpnn_run.py' # maybe?
    SABDAB_DIR = '/net/databases/lab/tcr_design/sabdab/'
